...
Before doing any material phase-research work, you MUST run the repo-local
...
node strike/customize/system/customize.mjs --repo-root <repo-root> preview phase-research
```
