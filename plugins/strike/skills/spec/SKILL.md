...
Before doing any material spec work, you MUST run the repo-local customization
...
node strike/customize/system/customize.mjs --repo-root <repo-root> preview spec
```
